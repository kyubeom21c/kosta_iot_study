...
public class BeverageMenuPage extends JFrame {

	public BeverageMenuPage() {
		...
		JLabel jl_beverage = new JLabel("BEVERAGE");
		title.add(jl_beverage);
		...
		ImageIcon img1 = new ImageIcon("./img/cola.jpg");
		...
		ImageIcon img2 = new ImageIcon("./img/soda.jpg");
		...
		ImageIcon img3 = new ImageIcon("./img/pocari.jpg");
		...
		ImageIcon img4 = new ImageIcon("./img/juice.jpg");
		...
		ImageIcon img5 = new ImageIcon("./img/coffee.jpg");
		...
		ImageIcon img6 = new ImageIcon("./img/latte.jpg");
